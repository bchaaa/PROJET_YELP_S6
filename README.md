...
- **Notebook 3 (Deep Learning)** : Réseau de Neurones Convolutif (CNN 1D) sous PyTorch.
  - *Performance* : ~91% Accuracy et F1-Score de 0.78 sur la détection d'avis négatifs.
  - *Technique* : Utilisation d'Embeddings et de filtres convolutifs pour extraire les séquences de mots (N-grams) pertinentes.
